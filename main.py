...
def main():
    tag_positions, all_observations, reference_tag_id = estimate_tag_positions_3d(
        video_path, detector, camera_matrix, dist_coeffs, tag_size, known_constraints=constraints
        ) 
